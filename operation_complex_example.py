...
from operation_complex import operation_digraph, OperationComplex, examine_structure
...
print('We can generate batches of flower complexes using the `examine_structure` utility.')
print('For example, here we see various flowers for addition modulo 6.')
a = FiniteRingStructure(6)
examine_structure(a,'+',5,8)